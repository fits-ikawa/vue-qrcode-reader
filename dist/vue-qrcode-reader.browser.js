                    ...
                    for (;;)
                      switch ((t.prev = t.next)) {
                        ...
                        case 5:
                          return (
                            (t.next = 7),
                            Object(l.a)(e.constraints, e.$refs.video, e.device)
                          );
                        case 7:
                ...
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 4:
                      ...
                      return (
                        (e.next = 8), navigator.mediaDevices.enumerateDevices()
                      );
                    case 8:
                      (o = e.sent),
                        (a = o.find(function(e) {
                        ...
                        a && (t.video.deviceId = a.deviceId);
                    case 11:
                      return (
                        (e.next = 13), navigator.mediaDevices.getUserMedia(t)
                      );
                    case 13:
                      return (
                        (i = e.sent),
                        void 0 !== r.srcObject
                          ...
                          : window.webkitURL
                          ? (r.src = window.webkitURL.createObjectURL(i))
                          : (r.src = i),
                        (e.next = 17),
                        Object(v.a)(r, "loadeddata")
                      );
                    case 17:
                      return e.abrupt("return", new h(r, i));
                    case 18:
                    case "end":
                      return e.stop();
                  }
